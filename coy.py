            ...
            for l in range(50,200):
                if (im1[i][j][0] == im2[k][l][0]) and (im1[i][j][1] == im2[k][l][1]) and (im1[i][j][2] == im2[k][l][2]):
                    ...
                    for s in range(maxim,120):
                        ...
                        for m in range(r):
                            for n in range(r):
                                x1=im1[i-(s+1)+m][j-(s+1)+n][0]
                                x2=im2[k-(s+1)+m][l-(s+1)+n][0]
                                y1=im1[i-(s+1)+m][j-(s+1)+n][1]
                                y2=im2[k-(s+1)+m][l-(s+1)+n][1]
                                z1=im1[i-(s+1)+m][j-(s+1)+n][2]
                                z2=im2[k-(s+1)+m][l-(s+1)+n][2]
                        if  ( x2>x1+0.50 ) or (x2<x1-0.50) or ( y2>y1+0.50 ) or (y2<y1-0.50) and ( z2>z1+0.50 ) or (z2<z1-0.50):
                            maxim =max(maxim,s)
                            break
            if (maxim>40):
                break
